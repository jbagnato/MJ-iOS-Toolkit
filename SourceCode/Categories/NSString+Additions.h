 ...
 **/
+ (nonnull NSAttributedString*)add_attributedStringWithStrings:(nonnull NSArray*)strings fonts:(nonnull NSArray<UIFont*>*)fonts textColors:(nonnull NSArray<UIColor*>*)colors;
 ...
 **/
+ (nonnull NSAttributedString*)add_attributedStringWithString:(nonnull NSString*)string font:(nonnull UIFont*)font textColor:(nonnull UIColor*)color;
